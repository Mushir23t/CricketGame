...
public class ScoreCard {
    ...
    private void Innings1Batting() {
        SaveBattingScorecard(I1);
    }

    private void Innings1Bowling() {
        SaveBowlingScorecard(I1);
    }

    private void Innings2Batting() {
        SaveBattingScorecard(I2);
    }

    private void Innings2Bowling() {
        SaveBowlingScorecard(I2);
    }


    private ArrayList<String> SaveBattingScorecard(Innings I) {
    ...
    private ArrayList<String> SaveBowlingScorecard(Innings I) {
        ArrayList<String> S = new ArrayList<>();
